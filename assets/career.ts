...
export const careers: CareerType[] = [
	...
	},
	{
      ...
      主にC#（.NET）、Javaを使って画面まわりの実装をしていました。また、仕様書の作成、プログラミング、テスト、保守、コード管理など開発に必要な業務を一通り行っていました。`,
		date: '2014.4'
	},
	{
		title: '機械学習',
		description: `独学で機械学習（DeepLearning）の勉強を始めました。
	...
	},
	{
      ...
      HTML・CSS・JavaSctiptの学習から始め、品質向上のためにTypeScript、フロントエンドフレームワークにReact、サーバーレス環境にFirebase、APIサーバーにNode.js（Express）を選択しました。`,
		date: '2021.1'
	}
]
